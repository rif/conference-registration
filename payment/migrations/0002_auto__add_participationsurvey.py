...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ParticipationSurvey'
        db.create_table('payment_participationsurvey', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('tutorial1', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('tutorial2', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('tutorial3', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('tutorial4', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('FAMOOSR', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('MESOA', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ))
        db.send_create_signal('payment', ['ParticipationSurvey'])


    def backwards(self, orm):
        
        # Deleting model 'ParticipationSurvey'
        db.delete_table('payment_participationsurvey')
    ...
    models = {
        ...
        'payment.participationsurvey': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tutorial1': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'tutorial2': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'tutorial3': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'tutorial4': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
        ...
        'payment.shoppingcart': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tutorial': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['auth.User']", 'unique': 'True'})
        }
    }
