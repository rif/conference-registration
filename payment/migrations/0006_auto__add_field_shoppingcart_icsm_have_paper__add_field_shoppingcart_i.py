...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ShoppingCart.icsm_have_paper'
        db.add_column('payment_shoppingcart', 'icsm_have_paper', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'ShoppingCart.icsm_paper_nb'
        db.add_column('payment_shoppingcart', 'icsm_paper_nb', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True), keep_default=False)

        # Adding field 'ShoppingCart.promise_have_paper'
        db.add_column('payment_shoppingcart', 'promise_have_paper', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'ShoppingCart.promise_paper_nb'
        db.add_column('payment_shoppingcart', 'promise_paper_nb', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True), keep_default=False)

        # Adding field 'ShoppingCart.wse_have_paper'
        db.add_column('payment_shoppingcart', 'wse_have_paper', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'ShoppingCart.wse_paper_nb'
        db.add_column('payment_shoppingcart', 'wse_paper_nb', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ShoppingCart.icsm_have_paper'
        db.delete_column('payment_shoppingcart', 'icsm_have_paper')

        # Deleting field 'ShoppingCart.icsm_paper_nb'
        db.delete_column('payment_shoppingcart', 'icsm_paper_nb')

        # Deleting field 'ShoppingCart.promise_have_paper'
        db.delete_column('payment_shoppingcart', 'promise_have_paper')

        # Deleting field 'ShoppingCart.promise_paper_nb'
        db.delete_column('payment_shoppingcart', 'promise_paper_nb')

        # Deleting field 'ShoppingCart.wse_have_paper'
        db.delete_column('payment_shoppingcart', 'wse_have_paper')

        # Deleting field 'ShoppingCart.wse_paper_nb'
        db.delete_column('payment_shoppingcart', 'wse_paper_nb')
    ...
    models = {
        ...
        'payment.shoppingcart': {
            ...
            'icsm_have_paper': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'icsm_paper_nb': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'payment_received': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'promise_have_paper': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'promise_paper_nb': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
            ...
            'wse_have_paper': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'wse_paper_nb': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'})
        }
    }
