...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ShoppingCart.FAMOOSR'
        db.add_column('payment_shoppingcart', 'FAMOOSR', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)

        # Adding field 'ShoppingCart.MESOA'
        db.add_column('payment_shoppingcart', 'MESOA', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ShoppingCart.FAMOOSR'
        db.delete_column('payment_shoppingcart', 'FAMOOSR')

        # Deleting field 'ShoppingCart.MESOA'
        db.delete_column('payment_shoppingcart', 'MESOA')
