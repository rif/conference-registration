...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cancelation.processed'
        db.add_column('hotels_cancelation', 'processed', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Cancelation.processed'
        db.delete_column('hotels_cancelation', 'processed')
