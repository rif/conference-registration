...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Hotel.special_price'
        db.delete_column('hotels_hotel', 'special_price')

        # Deleting field 'Hotel.special_rooms'
        db.delete_column('hotels_hotel', 'special_rooms')


    def backwards(self, orm):
        
        # Adding field 'Hotel.special_price'
        db.add_column('hotels_hotel', 'special_price', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Hotel.special_rooms'
        db.add_column('hotels_hotel', 'special_rooms', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
