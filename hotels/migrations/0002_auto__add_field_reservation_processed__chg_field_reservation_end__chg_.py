...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reservation.processed'
        db.add_column('hotels_reservation', 'processed', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Changing field 'Reservation.end'
        db.alter_column('hotels_reservation', 'end', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Reservation.start'
        db.alter_column('hotels_reservation', 'start', self.gf('django.db.models.fields.DateField')())


    def backwards(self, orm):
        
        # Deleting field 'Reservation.processed'
        db.delete_column('hotels_reservation', 'processed')

        # Changing field 'Reservation.end'
        db.alter_column('hotels_reservation', 'end', self.gf('django.db.models.fields.DateField')(blank=True))

        # Changing field 'Reservation.start'
        db.alter_column('hotels_reservation', 'start', self.gf('django.db.models.fields.DateField')(blank=True))
