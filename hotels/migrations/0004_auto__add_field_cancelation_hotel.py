...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cancelation.hotel'
        db.add_column('hotels_cancelation', 'hotel', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['hotels.Hotel']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Cancelation.hotel'
        db.delete_column('hotels_cancelation', 'hotel_id')
