...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reservation.smoker_room'
        db.add_column('hotels_reservation', 'smoker_room', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Reservation.smoker_room'
        db.delete_column('hotels_reservation', 'smoker_room')
