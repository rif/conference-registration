...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Status.author_paper_number'
        db.delete_column('userprofile_status', 'author_paper_number')


    def backwards(self, orm):
        
        # Adding field 'Status.author_paper_number'
        db.add_column('userprofile_status', 'author_paper_number', self.gf('django.db.models.fields.CharField')(max_length='20', null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'userprofile.about': {
            ...
            'food_preference': ('django.db.models.fields.CharField', [], {'default': "'NO'", 'max_length': '2'}),
