...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'About.like_jogging'
        db.add_column('userprofile_about', 'like_jogging', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'About.like_jogging'
        db.delete_column('userprofile_about', 'like_jogging')
