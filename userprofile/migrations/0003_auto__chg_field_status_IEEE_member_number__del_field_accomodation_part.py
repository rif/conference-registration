...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Status.IEEE_member_number'
        db.alter_column('userprofile_status', 'IEEE_member_number', self.gf('django.db.models.fields.CharField')(max_length='8', null=True, blank=True))

        # Deleting field 'Accomodation.partner'
        db.delete_column('userprofile_accomodation', 'partner')


    def backwards(self, orm):
        
        # Changing field 'Status.IEEE_member_number'
        db.alter_column('userprofile_status', 'IEEE_member_number', self.gf('django.db.models.fields.CharField')(max_length='20', null=True, blank=True))

        # Adding field 'Accomodation.partner'
        db.add_column('userprofile_accomodation', 'partner', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
