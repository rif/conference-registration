...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'About', fields ['email']
        db.create_unique('userprofile_about', ['email'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'About', fields ['email']
        db.delete_unique('userprofile_about', ['email'])
