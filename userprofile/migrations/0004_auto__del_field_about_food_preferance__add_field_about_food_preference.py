...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'About.food_preferance'
        db.delete_column('userprofile_about', 'food_preferance')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'About.food_preferance'
        db.add_column('userprofile_about', 'food_preferance', self.gf('django.db.models.fields.CharField')(default='NO', max_length=2), keep_default=False)
